...
public class SessionsImpl implements Sessions {
    ...
    interface SessionsService {
        ...
        @Headers({ "Content-Type: application/json-patch+json; charset=utf-8", "x-ms-logging-context: microsoft.bonsai.simulatorapi.Sessions create" })
        ...
        @Headers({ "Content-Type: application/json-patch+json; charset=utf-8", "x-ms-logging-context: microsoft.bonsai.simulatorapi.Sessions advance" })
