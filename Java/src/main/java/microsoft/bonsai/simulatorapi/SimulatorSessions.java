 ...
 */
public interface SimulatorSessions {
    /**
     ...
     */
    Object listSessions(String workspaceName);
     ...
     */
    ServiceFuture<Object> listSessionsAsync(String workspaceName, final ServiceCallback<Object> serviceCallback);
     ...
     */
    Observable<Object> listSessionsAsync(String workspaceName);
     ...
     * @return the observable to the Object object
     */
    Observable<ServiceResponse<Object>> listSessionsWithServiceResponseAsync(String workspaceName);
    /**
     * Implementaton of the GET /v2/.../simulatorSessions endpoint.
     * Retrieves all of the simulators currently registered with all
     simulator gateways within this workspace.
     ...
     * @return the Object object if successful.
     */
    Object listSessions(String workspaceName, String deploymentMode, String sessionStatus, String collection, String packageParameter);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Object> listSessionsAsync(String workspaceName, String deploymentMode, String sessionStatus, String collection, String packageParameter, final ServiceCallback<Object> serviceCallback);
     ...
     * @return the observable to the Object object
     */
    Observable<Object> listSessionsAsync(String workspaceName, String deploymentMode, String sessionStatus, String collection, String packageParameter);
     ...
     * @return the observable to the Object object
     */
    Observable<ServiceResponse<Object>> listSessionsWithServiceResponseAsync(String workspaceName, String deploymentMode, String sessionStatus, String collection, String packageParameter);
     ...
     * @return the Object object if successful.
     */
    Object registerSimulator(String workspaceName, SimulatorInterface registrationInfo);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Object> registerSimulatorAsync(String workspaceName, SimulatorInterface registrationInfo, final ServiceCallback<Object> serviceCallback);
     ...
     * @return the observable to the Object object
     */
    Observable<Object> registerSimulatorAsync(String workspaceName, SimulatorInterface registrationInfo);
     ...
     * @return the observable to the Object object
     */
    Observable<ServiceResponse<Object>> registerSimulatorWithServiceResponseAsync(String workspaceName, SimulatorInterface registrationInfo);
     ...
     * @return the Object object if successful.
     */
    Object describeOneSession(String workspaceName, String sessionId);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Object> describeOneSessionAsync(String workspaceName, String sessionId, final ServiceCallback<Object> serviceCallback);
     ...
     * @return the observable to the Object object
     */
    Observable<Object> describeOneSessionAsync(String workspaceName, String sessionId);
     ...
     * @return the observable to the Object object
     */
    Observable<ServiceResponse<Object>> describeOneSessionWithServiceResponseAsync(String workspaceName, String sessionId);
     ...
     */
    ProblemDetails deregisterSimulator(String workspaceName, String sessionId);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<ProblemDetails> deregisterSimulatorAsync(String workspaceName, String sessionId, final ServiceCallback<ProblemDetails> serviceCallback);
     ...
     */
    Observable<ProblemDetails> deregisterSimulatorAsync(String workspaceName, String sessionId);
     ...
     * @return the observable to the ProblemDetails object
     */
    Observable<ServiceResponse<ProblemDetails>> deregisterSimulatorWithServiceResponseAsync(String workspaceName, String sessionId);
     ...
     * @return the Event object if successful.
     */
    Event advance(String workspaceName, String sessionId, SimulatorState state);
     ...
     * @return the {@link ServiceFuture} object
     */
    ServiceFuture<Event> advanceAsync(String workspaceName, String sessionId, SimulatorState state, final ServiceCallback<Event> serviceCallback);
     ...
     * @return the observable to the Event object
     */
    Observable<Event> advanceAsync(String workspaceName, String sessionId, SimulatorState state);
     ...
     * @return the observable to the Event object
     */
    Observable<ServiceResponse<Event>> advanceWithServiceResponseAsync(String workspaceName, String sessionId, SimulatorState state);
