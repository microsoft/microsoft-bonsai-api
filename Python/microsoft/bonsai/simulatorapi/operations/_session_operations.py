...
class SessionOperations(object):
    ...
    :type models: ~microsoft.bonsai.simulatorapi.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: list[~microsoft.bonsai.simulatorapi.models.SimulatorSessionSummary]
    ...
    def create(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~microsoft.bonsai.simulatorapi.models.SimulatorInterface
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SimulatorSessionResponse, or the result of cls(response)
        :rtype: ~microsoft.bonsai.simulatorapi.models.SimulatorSessionResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_most_recent_action(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~microsoft.bonsai.simulatorapi.models.Event
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def advance(
        ...
        **kwargs  # type: Any
        ...
        :type body: ~microsoft.bonsai.simulatorapi.models.SimulatorState
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Event, or the result of cls(response)
        :rtype: ~microsoft.bonsai.simulatorapi.models.Event
        :raises: ~azure.core.exceptions.HttpResponseError
