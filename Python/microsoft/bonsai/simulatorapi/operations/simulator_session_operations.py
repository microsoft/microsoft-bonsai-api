...
class SimulatorSessionOperations(object):
    ...
    def list_sessions(
        ...
        """
        # Construct URL
        url = self.list_sessions.metadata['url']
        ...
        return deserialized
    list_sessions.metadata = {'url': '/v2/workspaces/{workspaceName}/simulatorSessions'}
    ...
    def register_simulator(
        ...
        if response.status_code == 201:
            deserialized = self._deserialize('SimulatorSession', response)
        if response.status_code == 400:
            deserialized = self._deserialize('ProblemDetails', response)
        ...
        return deserialized
    register_simulator.metadata = {'url': '/v2/workspaces/{workspaceName}/simulatorSessions'}

    def describe_one_session(
        ...
        """
        # Construct URL
        url = self.describe_one_session.metadata['url']
        path_format_arguments = {
            'workspaceName': self._serialize.url("workspace_name", workspace_name, 'str'),
        ...
        return deserialized
    describe_one_session.metadata = {'url': '/v2/workspaces/{workspaceName}/simulatorSessions/{sessionId}'}
    ...
    def deregister_simulator(
        ...
        :rtype: ~microsoft.bonsai.simulatorapi.models.ProblemDetails or
        ...
        return deserialized
    deregister_simulator.metadata = {'url': '/v2/workspaces/{workspaceName}/simulatorSessions/{sessionId}'}
    ...
    def advance(
            self, workspace_name, session_id, state, custom_headers=None, raw=False, **operation_config):
