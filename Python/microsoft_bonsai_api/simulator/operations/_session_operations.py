...
class SessionOperations(object):
    ...
    :type models: ~microsoft_bonsai_api.simulator.models
    ...
    def list(
        ...
        **kwargs  # type: Any
        ...
        :rtype: list[~microsoft_bonsai_api.simulator.models.SimulatorSessionSummary]
    ...
    def create(
        self,
        workspace_name,  # type: str
        body=None,  # type: Optional["models.SimulatorInterface"]
        **kwargs  # type: Any
    ):
        ...
        :type body: ~microsoft_bonsai_api.simulator.models.SimulatorInterface
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: SimulatorSessionResponse, or the result of cls(response)
        :rtype: ~microsoft_bonsai_api.simulator.models.SimulatorSessionResponse
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def get_most_recent_action(
        ...
        **kwargs  # type: Any
        ...
        :rtype: ~microsoft_bonsai_api.simulator.models.Event
        :raises: ~azure.core.exceptions.HttpResponseError
        """
    ...
    def advance(
        ...
        workspace_name,  # type: str
        session_id,  # type: str
        body=None,  # type: Optional["models.SimulatorState"]
        **kwargs  # type: Any
    ):
        # type: (...) -> "models.Event"
        ...
        :type body: ~microsoft_bonsai_api.simulator.models.SimulatorState
        :keyword callable cls: A custom type or function that will be passed the direct response
        :return: Event, or the result of cls(response)
        :rtype: ~microsoft_bonsai_api.simulator.models.Event
        :raises: ~azure.core.exceptions.HttpResponseError
