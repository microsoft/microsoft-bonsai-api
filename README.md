...
- [ ] For hosted sim, You can also enable Sim logging for Episodes, iterations and system log, using our CLI commands ([1](https://docs.microsoft.com/en-us/bonsai/cli/brain/version/start-training), 2) for start-training and start-logging. These logs will go to Log Analytics workspace. 
