...
import bonsai.simulatorapi.models.SimulatorSessionResponse;
import bonsai.simulatorapi.models.SimulatorSessionSummary;
...
public class SessionsImpl implements Sessions {
    ...
    interface SessionsService {
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: bonsai.simulatorapi.Sessions list" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: bonsai.simulatorapi.Sessions create" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: bonsai.simulatorapi.Sessions get" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: bonsai.simulatorapi.Sessions delete" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: bonsai.simulatorapi.Sessions getMostRecentAction" })
        ...
        @Headers({ "Content-Type: application/json; charset=utf-8", "x-ms-logging-context: bonsai.simulatorapi.Sessions advance" })
     ...
     * @return the Event object if successful.
     */
    public Event advance(String workspaceName, String sessionId) {
     ...
     * @return the {@link ServiceFuture} object
     */
    public ServiceFuture<Event> advanceAsync(String workspaceName, String sessionId, final ServiceCallback<Event> serviceCallback) {
     ...
     * @return the observable to the Event object
     */
    public Observable<Event> advanceAsync(String workspaceName, String sessionId) {
        return advanceWithServiceResponseAsync(workspaceName, sessionId).map(new Func1<ServiceResponse<Event>, Event>() {
            @Override
            public Event call(ServiceResponse<Event> response) {
                return response.body();
            }
     ...
     * @return the observable to the Event object
     */
    public Observable<ServiceResponse<Event>> advanceWithServiceResponseAsync(String workspaceName, String sessionId) {
        if (workspaceName == null) {
            throw new IllegalArgumentException("Parameter workspaceName is required and cannot be null.");
        }
        if (sessionId == null) {
